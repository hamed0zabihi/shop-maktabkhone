...
export function FakeDataProducts() {
  return [
    {
      id: 1,
      ...
      createAt: '2021-05-05T02:11:33.530Z',
      price: 110,
      inventory: 5,
      sellNumber: 20,
    },
    ...
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-03-01.png',
        '/images/product/gallery/p-03-02.png',
      ],
      description:
        ' Virtual Surround Sound Gaming Headset Black with Ambient Dragon Logo, Wired USB connector, 40mm Drivers, inline Smart .',
      createAt: '2021-05-03T03:11:33.530Z',
      price: 35,
      inventory: 7,
      sellNumber: 17,
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-04-01.png',
        '/images/product/gallery/p-04-02.png',
      ],
      description:
        'Comfortable, casual and loose fitting, our heavyweight t-shirt will quickly become one of your favorites. Made from 80% cotton, it wears well on anyone. We’ve double-needle stitched the bottom and sleeve hems for extra durability. Select a design from our marketplace or customize it to make it uniquely yours!.',
      createAt: '2021-05-04T04:11:33.530Z',
      price: 1200,
      inventory: 4,
      sellNumber: 16,
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-05-01.png',
        '/images/product/gallery/p-05-02.png',
      ],
      description:
        'Nothing as fly, nothing as comfortable, nothing as proven—the Nike Air Max 90 stays true to its roots with the iconic Waffle sole, stitched overlays and classic TPU accents. Fresh colors update the design while Max Air cushioning adds comfort to your journey. ',
      createAt: '2021-05-05T05:11:33.530Z',
      price: 120,
      inventory: 7,
      sellNumber: 15,
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-06-01.png',
      ...
      createAt: '2021-05-06T06:11:33.530Z',
      price: 140,
      inventory: 5,
      sellNumber: 14,
    },
    ...
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-08-01.png',
    ...
    },
    {
      ...
      description:
        'Coffee, tea, or art? Have it all with this eye-opening ceramic mug Holds 11 oz. (325 ml) Mug diameter is 3.2 (8.2 cm), not including handle.',
      createAt: '2021-05-10T10:11:33.530Z',
      price: 13,
      inventory: 6,
      sellNumber: 8,
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-11-01.png',
      ...
      createAt: '2021-05-11T11:11:33.530Z',
      price: 108,
      inventory: 11,
      sellNumber: 9,
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-12-01.png',
        '/images/product/gallery/p-12-02.png',
      ],
      description:
        'Just your everyday smooth, comfy tee, a wardrobe staple.Slim fit, so size up if you prefer a looser fit, or check out the Classic T-Shirt.Male model shown is 60 / 183 cm tall and wearing size Large Female model shown is 58 /173 cm tall and wearing size Small',
      createAt: '2021-05-12T11:11:33.530Z',
      price: 21,
      inventory: 5,
      sellNumber: 8,
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-13-01.png',
    ...
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-15-01.png',
        '/images/product/gallery/p-15-02.png',
      ],
      description:
        'Nike SKU CW7093 600 .Mens.UNIVERSITY RED/SPINACH .GREEN-MAGIC .EMBER',
      createAt: '2021-05-12T11:11:33.530Z',
      price: 250,
      inventory: 5,
      sellNumber: 8,
    },
    {
      ...
      imageGallery: [
        '/images/product/gallery/p-16-01.png',
        '/images/product/gallery/p-16-02.png',
      ],
      description:
        'Frame size is usually defined by lens, bridge and temple width. These values are always displayed in that order, in millimeters. As a reference, you may want to check the size of your current eyewear, by looking at the inside temple. Should you see a fourth number at the end, this refers to lens height',
      createAt: '2021-05-12T11:11:33.530Z',
      price: 113,
      inventory: 9,
      sellNumber: 16,
